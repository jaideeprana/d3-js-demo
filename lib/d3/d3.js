...
Path.prototype = path.prototype = {
  ...
  arc: function(x, y, r, a0, a1, ccw) {
    ...
    // Is this a complete circle.js? Draw two arcs to complete the circle.js.
    if (da > tauEpsilon) {
...
// Generates a circle.js centered at [0°, 0°], with a given radius and precision.
...
// and circle.js clipping, the same comparison is used.
...
function clipCircle(radius) {
    ...
    return {
      ...
      point: function(lambda, phi) {
        ...
        if (v !== v0) {
          ...
          // and there this segment intersects with the small circle.js.
  ...
  // Intersects the great circle.js between a and b with the clip circle.js.
  ...
  // the small circle.js's bounding box.
...
function packEnclose(circles) {
  ...
  // Place the first circle.js.
  a = circles[0], a.x = 0, a.y = 0;
  if (!(n > 1)) return a.r;

  // Place the second circle.js.
  b = circles[1], a.x = -b.r, b.x = a.r, b.y = 0;
  if (!(n > 2)) return a.r + b.r;

  // Place the third circle.js.
  ...
  // Attempt to place each remaining circle.js…
  pack: for (i = 3; i < n; ++i) {
    place(a._, b._, c = circles[i]), c = new Node$1(c);

    // Find the closest intersecting circle.js on the front-chain, if any.
    ...
    // Success! Insert the new circle.js c between a and b.
    c.previous = a, c.next = b, a.next = b.previous = b = c;

    // Compute the new closest circle.js pair to the centroid.
    aa = score(a);
    while ((c = c.next) !== b) {
      if ((ca = score(c)) < aa) {
        a = c, aa = ca;
  ...
  // Compute the enclosing circle.js of the front chain.
  a = [b._], c = b; while ((c = c.next) !== b) a.push(c._); c = enclose(a);

  // Translate the circles to put the enclosing circle.js around the origin.
...
function arc() {
  ...
  function arc() {
    ...
    // Or is it a circle.js or annulus?
